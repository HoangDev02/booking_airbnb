...
import HomeowerInfo from "../homeowerInfo/HomeowerInfo";
import BenifitRoomDetail from "../benifitRoomDetail/BenifitRoomDetail";
import ReviewRoomDetail from "../reviewRoomDetail/ReviewRoomDetail";
    ...
    <div className="container mx-auto mt-10">
      ...
      <div className="grid grid-cols-2 gap-4 mt-[5rem]">
        <div className="col-span-1 w-[50rem] relative">
          ...
          {/* reviews */}
          <ReviewRoomDetail rating={data.rating} hotelId={data.id}/>
          {/* dâu gạch hang */}
          <div className="bg-black w-[50rem] h-[2px] rounded-md opacity-5 mt-1 mb-2">
            ,
          </div>
